...
Categories.getListCategories = async (req, res) => {
    ...
    res.render('Pages/categorie/list-categories', { categories });
  };

  Categories.postCategories = async (req, res) => {
    const {
...
//eliminar
Categories.deleteCategories = async (req, res) => {
    const { id } = req.params;
  ...
  //editar
  Categories.getCategorie = async (req, res) => {
    const { id } = req.params;
    const categorie = await pool.query('SELECT * FROM categories WHERE id = ?', [id]);
    res.render('Pages/categories/edit-categories', { categorie: categorie[0] });
  };
  //actualizar
  Categories.updateCategories= async (req, res) => {
    const { id } = req.params;
  ...
  //agregar
  Players.getAddCategories = async (req, res) => {
