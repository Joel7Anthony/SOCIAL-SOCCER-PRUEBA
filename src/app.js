...
app.use(express.static(path.join(__dirname, 'public/images/img-playerstatistic')));
app.use(express.static(path.join(__dirname, 'public/images/img-teamstatistic')));
