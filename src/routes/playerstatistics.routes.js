...
const playerstatisticsController = require('../controllers/playerstatistics.controller');
...
//views photo
router.post('/photo-playerstatistics/:id', isLoggedIn, photoPlayersController.updatePhoto);
